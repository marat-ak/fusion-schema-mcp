...
if (!process.env.DATA_DIR) { console.error("DATA_DIR is required"); process.exit(2); }
process.env.CATALOG_DB = "sqlite";
const keepAlive = setInterval(() => {}, 1 << 30);
const dbm = await import("/app/dist/db/index.js");
await dbm.openCatalogDb(dbm.configFromEnv());
